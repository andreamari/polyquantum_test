...
The goal of Polyquantum is to apply the same methodologies and the same powerful tools that emerged in the context of open-source software to the context of open scientific research. The underpinning assumption is that both fields share the same basic needs: efficient collaborative writing of text documents, permanent recording of history, and verifiable authorship.
